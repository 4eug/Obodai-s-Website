...
function ProjectCard(props) {
    ...
    <div className="relative">
      ...
      <img
      src={props.src}
      className="w-[450px] h-[610px] sm:w-[400px] md:w-[1440px] md:h-[664px] 2xl:w-screen object-cover cursor-pointer"
      // width="1440"
      // height="664"
      priority
      />
        ...
        <p className="text-[16px] md:text-[24px] leading-4 text-white mt-1">{props.description}</p>
            ...
            <svg width="60" height="24" viewBox="0 0 72 24" className="mt-4 animate-bounce-right" fill="none" xmlns="http://www.w3.org/2000/svg">
