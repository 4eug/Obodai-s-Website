...
const ButtonItem = (props) => (
  <li>
    ...
    <svg width="18" height="50" className='animate-bounce' viewBox="0 0 24 66" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    return (
      <div className='flex items-center justify-center h-screen mb-12 bg-fixed bg-center bg-cover custom-img'>
        ...
        <div className='p-5 text-white z-[2] mt-[-0rem]'>
         ...
         <a className="relative inline-flex items-center justify-center w-32 h-32 text-gray-800 hover:text-gray-700" href="">
